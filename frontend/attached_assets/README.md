...
6. Access the application:
   - API endpoints will be available at http://backend:3005
   - Swagger documentation available at http://backend:3005/api
...
```bash
# Oracle example
curl -X POST http://backend:3005/ask \
...
Or use the Swagger UI at http://backend:3005/api for interactive testing.
